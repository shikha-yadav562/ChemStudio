...
class PossibleRadicalsCScreen extends StatefulWidget {
  final Map<int, String> userAnswers;
  final List<TestItem> tests;
  final Map<int, String> preliminaryAnswers;

  const PossibleRadicalsCScreen({
    super.key,
  ...
  @override
  State<PossibleRadicalsCScreen> createState() => _PossibleRadicalsCScreenState();
}

class _PossibleRadicalsCScreenState extends State<PossibleRadicalsCScreen> {
