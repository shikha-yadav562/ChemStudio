...
import 'dry_test_d.dart'; 
import '../../welcome_screen.dart';

const Color primaryBlue = Color(0xFF004C91);
const Color accentTeal = Color(0xFF00A6A6);

class PossibleRadicalsDScreen extends StatefulWidget {
  final Map<int, String> userAnswers;
  final List<TestItem> tests;
  final Map<int, String> preliminaryAnswers;

  const PossibleRadicalsDScreen({
    super.key,
  ...
  @override
  State<PossibleRadicalsDScreen> createState() => _PossibleRadicalsDScreenState();
}

class _PossibleRadicalsDScreenState extends State<PossibleRadicalsDScreen> {
