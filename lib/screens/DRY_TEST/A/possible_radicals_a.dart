...
class PossibleRadicalsaScreen extends StatefulWidget {
  final Map<int, String> userAnswers;
  final List<TestItem> tests;
  final Map<int, String> preliminaryAnswers;

  const PossibleRadicalsaScreen({
    super.key,
  ...
  @override
  State<PossibleRadicalsaScreen> createState() => _PossibleRadicalsaScreenState();
}

class _PossibleRadicalsaScreenState extends State<PossibleRadicalsaScreen> {
