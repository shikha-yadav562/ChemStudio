...
class saltA_Group6Detection extends StatefulWidget {
  final String? restoredSelection;
  const saltA_Group6Detection({super.key, this.restoredSelection});

  @override
  State<saltA_Group6Detection> createState() => _saltA_Group6DetectionState();
}

class _saltA_Group6DetectionState extends State<saltA_Group6Detection>
  ...
  void _next() async {
    if (_selectedOption == 'Group-VI present') {
      await Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const saltA_Group6Analysis()),
      );
    }
