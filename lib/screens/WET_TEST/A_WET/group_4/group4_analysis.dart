...
class saltAgroup4_analysis extends StatefulWidget {
  const saltAgroup4_analysis({super.key});

  @override
  State<saltAgroup4_analysis> createState() => _saltAgroup4_analysisState();
}

class _saltAgroup4_analysisState extends State<saltAgroup4_analysis>
  ...
  void _next() {
    if (selectedInference == "Ni²⁺") {
      Navigator.push(context,
          MaterialPageRoute(builder: (_) => const saltA_Ni2ConfirmedPage()));
    } else if (selectedInference == "Co²⁺") {
      Navigator.push(context,
          MaterialPageRoute(builder: (_) => const saltA_Co2ConfirmedPage()));
    } else if (selectedInference == "Mn²⁺") {
      Navigator.push(context,
          MaterialPageRoute(builder: (_) => const saltA_Mn2ConfirmedPage()));
    } else if (selectedInference == "Zn²⁺") {
      Navigator.push(context,
          MaterialPageRoute(builder: (_) => const saltA_Zn2ConfirmedPage()));
    }
  }
