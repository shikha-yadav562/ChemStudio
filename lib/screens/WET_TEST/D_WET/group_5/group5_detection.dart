...
class saltD_Group5DetectionScreen extends StatefulWidget {
  const saltD_Group5DetectionScreen({super.key});

  @override
  State<saltD_Group5DetectionScreen> createState() => _saltD_Group5DetectionScreenState();
}

class _saltD_Group5DetectionScreenState extends State<saltD_Group5DetectionScreen>
  ...
  void _next() async {
    if (_selectedOption == 'Group-V is present') {
      ...
      await Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const saltD_Group6Detection()),
      );
    }
  }
