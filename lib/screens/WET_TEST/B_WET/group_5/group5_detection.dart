...
class saltB_Group5DetectionScreen extends StatefulWidget {
  const saltB_Group5DetectionScreen({super.key});

  @override
  State<saltB_Group5DetectionScreen> createState() => _saltB_Group5DetectionScreenState();
}

class _saltB_Group5DetectionScreenState extends State<saltB_Group5DetectionScreen>
  ...
  void _next() async {
    if (_selectedOption == 'Group-V is present') {
      ...
      await Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const saltB_Group6Detection()),
      );
    }
  }
