...
class saltB_Group6Analysis extends StatefulWidget {
  const saltB_Group6Analysis({super.key});

  @override
  State<saltB_Group6Analysis> createState() => _saltB_Group6AnalysisState();
}

class _saltB_Group6AnalysisState extends State<saltB_Group6Analysis>
  ...
  void _next() async {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => const saltB_group6_ct_MGPage(), // Next page for Mg²⁺ confirmation
      ),
    );
  }
