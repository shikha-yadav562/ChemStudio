...
class saltBGroup4DetectionScreen extends StatefulWidget {
  const saltBGroup4DetectionScreen({super.key});

  @override
  State<saltBGroup4DetectionScreen> createState() => _saltBGroup4DetectionScreenState();
}

class _saltBGroup4DetectionScreenState extends State<saltBGroup4DetectionScreen>
  ...
  void _next() {
    if (selectedOption == "Group-IV Present") {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const saltBgroup4_analysis()),
      );
