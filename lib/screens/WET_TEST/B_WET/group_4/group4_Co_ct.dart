...
class saltB_Co2ConfirmedPage extends StatefulWidget {
  const saltB_Co2ConfirmedPage({super.key});

  @override
  State<saltB_Co2ConfirmedPage> createState() => _saltB_Co2ConfirmedPageState();
}

class _saltB_Co2ConfirmedPageState extends State<saltB_Co2ConfirmedPage> {
