...
class group6_ct_MG extends StatefulWidget {
  const group6_ct_MG({super.key});

  @override
  State<group6_ct_MG> createState() => _group6_ct_MGState();
}

class _group6_ct_MGState extends State<group6_ct_MG> {
