...
class _Zn2ConfirmedPageState extends State<Zn2ConfirmedPage> {
  ...
  Widget _buildContent() {
    // Content moved from Stack/ListView to a Column for SingleChildScrollView
    return Column(
      ...
      child: const Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 6),
            Text(
              "Dissolve the white ppt in dilute HCl and remove H₂S gas by boiling. Use this solution for C.T",
              style:
